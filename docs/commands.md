...
The current test ROM reports `1MHzWifi 0.1.18 (C) 2026 Peter Clarke`, followed
...
kernel revision, for example `Pi1MHz ElkWiFi 0.1.18, kernel
V1.30-80-g8468a38-dirty.01b459a6`.
