...
The current test ROM reports `1MHzWifi 0.1.9 (C) 2026 Peter Clarke`, followed
...
following line identifies the Pi-side service, its WiFi state, and the generated
Pi1MHz kernel revision, for example `kernel V1.30-80-g8468a38-dirty.<hash>`.
