...
The current ROM reports `1MHzWifi 0.1.54 (C) 2026 Peter Clarke`, followed
...
kernel revision. The packaged kernels report `Pi1MHz ElkWiFi 0.1.54, kernel
V1.30-84-gd08242e-dirty.73d7472b`. Use the SHA-256 values in `SHA256SUMS` to identify
