...
The current test ROM reports `1MHzWifi 0.1.37 (C) 2026 Peter Clarke`, followed
...
kernel revision, for example `Pi1MHz ElkWiFi 0.1.37, kernel
V1.30-83-g516a267-dirty.649d6829`.
