...
The current ROM reports `1MHzWifi 0.1.55 (C) 2026 Peter Clarke`, followed
...
kernel revision. The packaged kernels report `Pi1MHz ElkWiFi 0.1.55, kernel
V1.30-84-gd08242e-dirty.e82d03ab`. Use the SHA-256 values in `SHA256SUMS` to identify
