...
The current test ROM reports `1MHzWifi 0.1.30 (C) 2026 Peter Clarke`, followed
...
kernel revision, for example `Pi1MHz ElkWiFi 0.1.30, kernel
V1.30-83-g516a267-dirty.5e877218`.
