...
`*ONLINE` requires the matched 0.1.6 Pi kernel. An older kernel does not own
service command 92 and returns `Not implemented`.
...
The current test ROM reports `1MHzWifi 0.1.6 (C) 2026 Peter Clarke`, followed
