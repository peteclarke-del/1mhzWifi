...
| `*VERSION` | Prints the `1MHz-WiFi` ROM revision, original ElkWiFi credit and Pi service response |

The current ROM reports `1MHz-WiFi 0.1.67 (C) 2026 Peter Clarke`, followed
...
kernel revision. The packaged kernels report `Pi1MHz ElkWiFi 0.1.67, kernel
...
OSFILE path. 1MHz-WiFi does not select, address or transfer the file to a Tube
