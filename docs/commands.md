...
The current test ROM reports `1MHzWifi 0.1.40 (C) 2026 Peter Clarke`, followed
...
kernel revision, for example `Pi1MHz ElkWiFi 0.1.40, kernel
V1.30-83-g516a267-dirty.f5c9ed2e`.
