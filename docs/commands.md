...
The current test ROM reports `1MHzWifi 0.1.7 (C) 2026 Peter Clarke`, followed
...
following line identifies the Pi-side service.
...
The maximum file length is `&FFFE` bytes. Escape is checked at each 256-byte
