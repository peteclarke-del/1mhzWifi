...
class IntegrationContractTest(unittest.TestCase):
    ...
    def test_wget_and_wicfs_use_the_pi_transport_and_jim_windows(self) -> None:
        ...
        self.assertIn("STA sbufh\n+    LDA sbufl\n+    STA tape_len_lo", rewind_patch)
        self.assertIn(".rewind_cmd\n-    jsr cfsinit", rewind_patch)
        self.assertNotIn(".xmess\tASL\tA\n+", rewind_patch)
        ...
        self.assertNotIn("+    sta pagereg", rewind_patch)
    ...
    def test_rom_startup_and_absent_service_are_fail_safe(self) -> None:
        ...
        self.assertIn('romversion         equs "0.1.0"', identity)
